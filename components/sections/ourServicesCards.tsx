...
export default function ServicesCards() {
  const services = [
    ...
    },
    {
      ...
      description:
        'Coordinación y seguimiento de la disposición final conforme a la normativa ambiental aplicable para cada tipo de residuo.',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth={1.8}
            d="M4 7h16M7 7V5a1 1 0 011-1h8a1 1 0 011 1v2m-9 0l1 12h8l1-12"
          />
        </svg>
      ),
    },
    {
      ...
      description:
        'Seguimiento continuo de procesos, cumplimiento normativo y reportes para mantener control operativo y ambiental.',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth={1.8}
            d="M4 18h16M7 15V7m5 8V4m5 11v-6"
          />
        </svg>
      ),
    },
  ...
  return (
    <section className="w-full bg-white py-20 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        {/* Grilla de 6 Tarjetas de Servicios con acentos en #8A1B1B */}
